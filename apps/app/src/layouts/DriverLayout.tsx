...
import { Home, Activity, Monitor, Mic, Settings, LogOut, User, ChevronDown } from 'lucide-react';
...
export function DriverLayout() {
  ...
  const navItems = [
    ...
    { to: '/driver/hud', icon: Monitor, label: 'HUD' },
    { to: '/driver/voice', icon: Mic, label: 'Voice' },
  ];
