...
export const TRACK_DATA: Record<string, TrackData> = {
  ...
  'daytona': {
    ...
    corners: [
      // Shape 381 starts at tri-oval (distPct 0), goes through infield, bus stop, back to oval
      // Positions calibrated to 381.shape.json centerline distPct values
      { number: 1, name: 'Turn 1', type: 'hairpin', apex: { distance: 200, x: 800, y: 170, normalizedDistance: 0.175 }, braking: { distance: 100, x: 850, y: 145 }, exit: { distance: 300, x: 750, y: 185 }, gear: 1, apexSpeed: 60, difficulty: 'hard', notes: 'Heavy braking into infield' },
      { number: 2, name: 'Turn 2', type: 'right', apex: { distance: 500, x: 710, y: 175, normalizedDistance: 0.195 }, entry: { distance: 400, x: 750, y: 185 }, exit: { distance: 600, x: 650, y: 140 }, gear: 3, apexSpeed: 95, difficulty: 'medium' },
      { number: 3, name: 'Turn 3 (Kink)', type: 'left', apex: { distance: 800, x: 500, y: 137, normalizedDistance: 0.230 }, entry: { distance: 700, x: 600, y: 138 }, exit: { distance: 900, x: 400, y: 150 }, gear: 5, apexSpeed: 140, difficulty: 'easy', notes: 'Flat out kink' },
      { number: 4, name: 'Turn 4', type: 'left', apex: { distance: 1100, x: 260, y: 220, normalizedDistance: 0.278 }, braking: { distance: 1000, x: 330, y: 175 }, exit: { distance: 1200, x: 200, y: 280 }, gear: 2, apexSpeed: 75, difficulty: 'medium' },
      { number: 5, name: 'Turn 5', type: 'right', apex: { distance: 1400, x: 160, y: 420, normalizedDistance: 0.320 }, entry: { distance: 1300, x: 175, y: 350 }, exit: { distance: 1500, x: 165, y: 500 }, gear: 3, apexSpeed: 100, difficulty: 'medium', notes: 'Exit critical for oval' },
      { number: 6, name: 'Turn 6 (Oval 1)', type: 'left-kink', apex: { distance: 2000, x: 200, y: 750, normalizedDistance: 0.420 }, entry: { distance: 1800, x: 175, y: 600 }, exit: { distance: 2200, x: 250, y: 850 }, gear: 6, apexSpeed: 180, difficulty: 'easy', notes: 'On to banking' },
      { number: 7, name: 'Bus Stop Entry', type: 'chicane', apex: { distance: 3000, x: 600, y: 940, normalizedDistance: 0.560 }, braking: { distance: 2900, x: 500, y: 930 }, exit: { distance: 3100, x: 700, y: 920 }, gear: 3, apexSpeed: 90, difficulty: 'hard', notes: 'Brake at 150 board' },
      { number: 8, name: 'Bus Stop Exit', type: 'chicane', apex: { distance: 3200, x: 850, y: 880, normalizedDistance: 0.600 }, entry: { distance: 3100, x: 750, y: 900 }, exit: { distance: 3300, x: 950, y: 850 }, gear: 3, apexSpeed: 95, difficulty: 'hard' },
      { number: 9, name: 'Turn 9 (Oval 3)', type: 'left-kink', apex: { distance: 4000, x: 1400, y: 540, normalizedDistance: 0.765 }, entry: { distance: 3800, x: 1300, y: 620 }, exit: { distance: 4200, x: 1500, y: 450 }, gear: 6, apexSpeed: 190, difficulty: 'easy' },
      { number: 10, name: 'Turn 10 (Oval 4)', type: 'left-kink', apex: { distance: 4800, x: 1600, y: 400, normalizedDistance: 0.810 }, entry: { distance: 4600, x: 1550, y: 420 }, exit: { distance: 5000, x: 1700, y: 500 }, gear: 6, apexSpeed: 195, difficulty: 'easy', notes: 'Tri-oval start' },
    ],
    svg: {
      viewBox: '0 0 500 450',
