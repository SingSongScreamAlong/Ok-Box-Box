    ...
    <div className="bg-black/60 backdrop-blur-xl border border-white/10 p-8 md:p-10">
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center">
          <span className="px-4 bg-black/60 text-xs text-white/30 uppercase tracking-wider">or continue with</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-8">
        <button
          ...
          className="btn btn-outline h-11 text-xs gap-2"
        >
      ...
      <p className="text-center text-sm text-white/50">
        New to Ok, Box Box?{' '}
        <Link to="/signup" className="text-[#f97316] hover:text-[#fb923c] transition-colors font-medium">
          Create account
        </Link>
      </p>
    </div>
